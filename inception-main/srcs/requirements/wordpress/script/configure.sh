...
if [ ! -f "/var/www/html/index.html" ]; then
    ...
    echo "ciao3"
    wp core install --url=$DOMAIN_NAME --title=rbordinsite --admin_user=$WP_USER_ADMIN --admin_password=$WP_PWD_ADMIN --admin_email=$WP_EMAIL_ADMIN --skip-email --allow-root
    echo "ciao4"
